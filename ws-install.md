...
I also tested installing via flatpak, but I didn't get it to capture anything.

### Getting newer versions on Linux
You build it from source (its Linux, right?). 

Its moderatly difficult. It downloads a sizeable amount of packages and builts quite a while. Don't try during the lesson ;-)
...
some 3rd party build script (read the comments on this page)
